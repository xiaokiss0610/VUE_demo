...
<template>
  <div class="main">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>空值验证规则配置</el-breadcrumb-item>
    </el-breadcrumb>
    <el-col :span="18" style="margin: 20px 12%">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" style="margin: 0px auto;" class="demo-ruleForm">
        <el-form-item label="空值描述" prop="name">
          <el-input v-model="ruleForm.name"></el-input>
        </el-form-item>
        <el-form-item label="空值类型" prop="region">
        ...
        <el-form-item label="空值规则" prop="type">
          <el-checkbox-group v-model="ruleForm.type">
            <el-checkbox label="信息因素" name="type"></el-checkbox>
            <el-checkbox label="技术因素" name="type"></el-checkbox>
            <el-checkbox label="流程因素" name="type"></el-checkbox>
            <el-checkbox label="管理因素" name="type"></el-checkbox>
          </el-checkbox-group>
        </el-form-item>
