  ...
  <div class="main">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-form :inline="true" :model="searchForm" class="demo-form-inline">
        ...
        <el-col :span="6">
          <el-input v-model="searchForm.state" placeholder="请输入交换类型">
            <template slot="prepend">交换类型：</template>
          </el-input>
        </el-col>
      ...
      >
        ...
        >
          <template scope="scope">
            <el-button class="editTextBtn" type="text" icon="el-icon-wtcms-tijiao" size="mini">成功</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--列表底部工具条和分页符-->
