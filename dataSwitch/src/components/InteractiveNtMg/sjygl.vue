  ...
  <div class="main">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-form :inline="true" :model="searchForm" class="demo-form-inline">
        <el-col :span="6">
          <el-input v-model="searchForm.orgName" placeholder="请输入数据库名称">
            <template slot="prepend">数据库名称：</template>
          </el-input>
        </el-col>
        <el-col :span="6">
          <el-input v-model="searchForm.type" placeholder="请输入用户登录名">
            <template slot="prepend">用户登录名：</template>
          </el-input>
        </el-col>
      ...
      >
        ...
        <el-table-column label="操作"
          ...
          <template scope="scope">
            <el-button class="editTextBtn" type="text" icon="el-icon-edit" size="mini" @click="editClick(scope.row)">
              编辑
            </el-button>
            <el-button class="delTextBtn" type="text" icon="el-icon-delete" size="mini" @click="deleteClick(scope.row)">
              删除
            </el-button>
          </template>
        </el-table-column>
